...
/**
 * Set holiday list
 * @param holidays_per_years Selected holiday dataset
 * @returns undefined
 */
 export function setHolidays(holidays_per_years: Holiday<string>[]): void;
 ...
 * @returns undefined
 */
 export function isIncludeHolidays(date: Date): boolean;
